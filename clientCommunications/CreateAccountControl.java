...
public class CreateAccountControl implements ActionListener
{
  ...
  public CreateAccountControl(JPanel container, HangmanClient client)
  {
  ...
  {
    CreateAccountPanel createAccountPanel = (CreateAccountPanel)container.getComponent(2);
    HangmanClientGUI clientGUI = (HangmanClientGUI)SwingUtilities.getWindowAncestor(createAccountPanel);
