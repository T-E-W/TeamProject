...
public class HangmanClientGUI extends JFrame
{
	...
	//	ContactControl coc = new ContactControl(container, client);
		...
		JPanel view2 = new LoginPanel(container, client);
		JPanel view3 = new CreateAccPanel(container, client);
		JPanel view4 = new StartGamePanel(container, client);
